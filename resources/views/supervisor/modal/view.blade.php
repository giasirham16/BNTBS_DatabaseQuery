            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control bg-light" id="detail-checker" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="detail-tanggalRequest" class="col-form-label">Tanggal Request</label>
                        <input type="text" class="form-control bg-light" id="detail-tanggalRequest"
                            readonly>
                    </div>
                    <div class="col">
                        <label for="detail-tanggalApproval" class="col-form-label">Tanggal Approval</label>
                        <input type="text" class="form-control bg-light" id="detail-tanggalApproval" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <textarea rows="2" style="resize: vertical; overflow-y: auto;" class="form-control bg-light"
                            id="detail-deskripsi" readonly></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
